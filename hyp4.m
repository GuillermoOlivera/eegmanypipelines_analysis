...
info.experiment_name = ['Hypothesis_4' reref dospectralanalysis];
info.event_types = {'manmade_old_hit_subs_rem';% subsequently remembered
...
info.high_pass_lower_limit_hz = 2;
...
info.spectra_time_window_ms = [0 500];
summary_spectral = spectral_analysis(info, folder_analysed_data, subject_files);
info.spectra_time_window_ms = [0 200];
summary_spectral = spectral_analysis(info, folder_analysed_data, subject_files);
