...
if isOctave
    ...
    folder_analysed_data = '/media/cygnuseco/ext4_files/research/EMP_data/EMP_data/eeg_brainvision/_analysed_hyp4ab'; 
else
    ...
    folder_analysed_data = 'w:\EMP_data\EMP_data\eeg_brainvision\_analysed_hyp4ab';
end
...
event_info = struct();
event_types = ['manmade_old_hit_subs_rem' ; % subsequently remembered
               ...
               'natural_old_mis_subs_rem'
               'natural_old_miss_subs_for']

condition_values = [1111;
                    1110;
                    1121
                    1120
                    2111
...
cond_1 = mean(subject_erp_mean.manmade_old_hit_subs_rem(:, selected_electrodes), 2);
cond_2 = mean(subject_erp_mean.manmade_old_hit_subs_for(:, selected_electrodes), 2);
cond_3 = mean(subject_erp_mean.manmade_old_miss_subs_rem(:, selected_electrodes), 2);
cond_4 = mean(subject_erp_mean.manmade_old_miss_subs_for(:, selected_electrodes), 2);
cond_5 = mean(subject_erp_mean.natural_old_hit_subs_rem(:, selected_electrodes), 2);
cond_6 = mean(subject_erp_mean.natural_old_hit_subs_for(:, selected_electrodes), 2);
cond_7 = mean(subject_erp_mean.natural_old_miss_subs_rem(:, selected_electrodes), 2);
cond_8 = mean(subject_erp_mean.natural_old_miss_subs_for(:, selected_electrodes), 2);
time_vector = 1/512*(1:length(cond_1)) - pre_stimulus_ms / 1000;
figure; plot(time_vector, cond_1, 'LineWidth', 2)
hold on
plot(time_vector, cond_2, 'LineWidth', 2)
plot(time_vector, cond_3, 'LineWidth', 2)
plot(time_vector, cond_4, 'LineWidth', 2)

figure; plot(time_vector, cond_5, 'LineWidth', 2)
hold on
plot(time_vector, cond_6, 'LineWidth', 2)
plot(time_vector, cond_7, 'LineWidth', 2)
plot(time_vector, cond_8, 'LineWidth', 2)
