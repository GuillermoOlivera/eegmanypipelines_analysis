...
if isOctave
    ...
    folder_analysed_data = '../research/EMP_data/EMP_data/eeg_brainvision/_analysed_matlab_full_10'; 
else
...
figure; plot(time_vector, hyp_1, 'LineWidth', 2)
hold on
plot(time_vector, hyp_2, 'LineWidth', 2)
plot(time_vector, hyp_3, 'LineWidth', 2)
plot(time_vector, hyp_4, 'LineWidth', 2)
