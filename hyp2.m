...
if isOctave
    ...
    folder_analysed_data = '/media/cygnuseco/ext4_files/research/EMP_data/EMP_data/eeg_brainvision/_analysed_hyp2abc_withoutreref'; 
else
    ...
    folder_analysed_data = 'w:\EMP_data\EMP_data\eeg_brainvision\_analysed_hyp2abc';
end
...
cond_1 = mean(subject_erp_mean.manmade_new(:, selected_electrodes), 2);
cond_2 = mean(subject_erp_mean.manmade_old(:, selected_electrodes), 2);
cond_3 = mean(subject_erp_mean.natural_new(:, selected_electrodes), 2);
cond_4 = mean(subject_erp_mean.natural_old(:, selected_electrodes), 2);
